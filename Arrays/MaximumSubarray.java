...
public class MaximumSubarray {
    ...
    public static int maxSubarraySumBF(int[] arr, int n) {
    ...
    public static int maxSubarraySumBetterApproach(int[] arr, int n) {
        int maxi = Integer.MIN_VALUE; // maximum sum
...
//Kadence Algorithm :
    ...
    //
    //    Space Complexity: O(1) as we are not using any extra space.
    public static long maxSubarraySumKadenceAlgo(int[] arr, int n) {
    ...
    //Intuition: The intuition of the algorithm is not to consider the subarray as a part of the answer if its sum is less than 0.
